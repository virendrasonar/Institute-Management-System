            ...
            >
              ...
              <div class="form-section slide-in-right">
                ...
                <mat-form-field appearance="fill" class="ultra-field">
                  ...
                  <input matInput type="url" formControlName="thumbnailUrl"
                    placeholder="https://example.com/course-thumbnail.jpg" />
                  <mat-icon matSuffix class="field-icon">add_photo_alternate</mat-icon>
                  <mat-hint>Use a publicly accessible HTTPS image URL.</mat-hint>
                </mat-form-field>
                <div class="thumbnail-preview" *ngIf="courseForm.get('thumbnailUrl')?.value as thumbnailUrl">
                  <img [src]="thumbnailUrl" alt="Course thumbnail preview" />
              ...
              <div class="form-section slide-in-left">
                ...
                <mat-form-field appearance="fill" class="ultra-field">
                  ...
                  <mat-select formControlName="videoType">
                    <mat-option value="NONE">No video</mat-option>
                    <mat-option value="YOUTUBE">YouTube</mat-option>
                  </mat-select>
                  <mat-hint>Uploaded video is unavailable because this project has no file storage service.</mat-hint>
                </mat-form-field>
              </div>

              <div class="form-section slide-in-right"
                *ngIf="courseForm.get('videoType')?.value === 'YOUTUBE'">
                <div class="field-header">
                ...
                <mat-form-field appearance="fill" class="ultra-field">
                  ...
                  <input matInput type="url" formControlName="videoUrl"
                    placeholder="https://www.youtube.com/watch?v=VIDEO_ID" />
                  <mat-icon matSuffix class="field-icon">smart_display</mat-icon>
                  <mat-hint>Supports youtube.com/watch and youtu.be links.</mat-hint>
                  <mat-error *ngIf="courseForm.hasError('youtubeUrl')">
              ...
              <div class="form-section slide-in-left">
                ...
                <mat-form-field appearance="fill" class="ultra-field">
                  <mat-label>Material links or names</mat-label>
                  <textarea matInput formControlName="materials" rows="3"
                    placeholder="Add one resource per line (URLs or resource names)"></textarea>
                  <mat-hint>Optional. Separate multiple resources with a new line.</mat-hint>
                </mat-form-field>
              </div>
...
export class CourseFormComponent implements OnInit {
  ...
  private courseMediaValidator(group: AbstractControl): ValidationErrors | null {
    if (group.get("videoType")?.value !== "YOUTUBE") return null;

    const url = (group.get("videoUrl")?.value || "").trim();
    const youtubeUrl = /^https?:\/\/(?:(?:www|m)\.)?(?:youtube\.com\/watch\?(?:[^\s#]*&)?v=[A-Za-z0-9_-]{11}(?:[&#].*)?|youtu\.be\/[A-Za-z0-9_-]{11}(?:[?&#].*)?)$/i;
    return youtubeUrl.test(url) ? null : { youtubeUrl: true };
  }
