...
class AdminServiceTest {
    ...
    void testGetAllCourses() {
        ...
        when(courseRepository.findAll(any(Sort.class))).thenReturn(courses);
    ...
    void testGetAllStudents() {
        ...
        verify(studentRepository).findAll(any(Sort.class));
    }
    ...
    void testGetAllMessages() {
        ...
        when(messageRepository.findAll(any(Sort.class))).thenReturn(messages);

        List<Message> result = adminService.getAllMessages();

        assertEquals(1, result.size());
        assertEquals(testMessage, result.get(0));
        verify(messageRepository).findAll(any(Sort.class));
    }
